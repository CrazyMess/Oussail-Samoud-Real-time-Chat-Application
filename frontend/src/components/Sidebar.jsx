...
import { getFriends, sendFriendRequest } from "../redux/actions/friendActions";
...
const Sidebar = () => {
  ...
  // TODO: add logic for searching users
  const handleSearch = () => {
    setFoundUsers(users.filter((user) => user.fullName.toLowerCase().includes(searchTerm.toLowerCase())));
  };
